        ...
        { data && data.map((e, index) => (
          ...
          >
            ...
            <div className='flex flex-col gap-5'>
              <p className='font-[700] text-[16px] text-[#FB2E86]'>Тав тухтай орчинг таны амьдралд</p>
              <p className='font-[800] text-[53px] '>2024 оны хамгийн шинэ загвар</p>
              <p className='font-[700] text-[16px] w-[350px] text-[#8A8FB9]'>{e?.description}</p>
              <button className='bg-[#FB2E86] w-[150px] text-[white] p-3'>Дэлгэрэнгүй</button>
            </div>
