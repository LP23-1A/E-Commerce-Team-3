    ...
    <div className=" h-auto flex  flex-col justify-between  gap-[110px]">
      ...
      <div className="flex items-center flex-col gap-10 ">
        <div className=" bg-white shadow-lg rounded-md py-[24px] w-[496px] h-fit px-[32px] flex items-center flex-col ">
          ...
          <p className="text-[#9096B2] text-[17px] font-normal">
            Доорх мэдээллийг бөглөнө үү
          </p>
          <div className="mt-12 flex flex-col gap-2">
            <input
              onChange={(e) => handleBack("email", e.target.value)}
              type="email"
          ...
          <div className="   flex justify-center items-center flex-col gap-2">
            <button className="text-[#9096B2] text-[17px] font-normal">
              Нууц үгээ мартсан
            </button>
            <button
              onClick={handlePost}
              className="bg-[#FB2E86] text-white   w-[432px]  h-[47px]   rounded-md"
            >
              Бүртгүүлэх
            </button>
            <button
              onClick={() => router.push("/user/login")}
              className="text-[#9096B2] text-[17px] font-normal"
            >
              Нэвтрэх хэсэг
            </button>
          </div>
