            ...
            <div className='bg-[#F4F4FC] w-[792px] h-[920px] py-[50px] px-[50px]'>
              <div>
                <div className='flex flex-col justify-around h-[200px]'>
                  ...
                  <input onChange={(e) => handleBack('phoneNumber', e.target.value)} className='bg-[#F4F4FC] border-b-2 border-[#BFC5E0]' type="text" placeholder='Email or mobile phone number' />
                ...
                <div className='flex flex-col gap-[20px]  mt-[100px]'>
                  ...
                  <div className='flex justify-between '>
                    <input onChange={(e) => handleBack('firstName', e.target.value)} className='bg-[#F4F4FC] border-b-2 border-[#BFC5E0] w-[336px]' type="text" placeholder='First name (optional)' />
                    <input onChange={(e) => handleBack('lastName', e.target.value)} className='bg-[#F4F4FC] w-[336px] border-b-2 border-[#BFC5E0]' type="text" placeholder='Last name' />
                  </div>
                  <div className='flex flex-col gap-[20px]'>
                    <input onChange={(e) => handleBack('address', e.target.value)} className='bg-[#F4F4FC] border-b-2 border-[#BFC5E0]' type="text" placeholder='Address' />
                    <input onChange={(e) => handleBack('apartment', e.target.value)} className='bg-[#F4F4FC] border-b-2 border-[#BFC5E0]' type="text" placeholder='Appaetnentment,suit,e.t.c (optinal)' />
                    <input onChange={(e) => handleBack('city', e.target.value)} className='bg-[#F4F4FC] border-b-2 border-[#BFC5E0]' type="text" placeholder='City' />
                  </div>
                  <div className='flex justify-between'>
                    <input onChange={(e) => handleBack('description', e.target.value)} className='bg-[#F4F4FC] border-b-2 border-[#BFC5E0] w-[336px]' type="text" placeholder='description' />
                    <input onChange={(e) => handleBack('zipCode', e.target.value)} className='bg-[#F4F4FC] border-b-2 border-[#BFC5E0] w-[336px]' type="number" placeholder='Zip Code' />
                  </div>
                </div>
              </div>
            </div>
