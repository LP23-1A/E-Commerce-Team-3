          ...
          <div className="bg-white w-[1200px] h-[160px] rounded-xl">
            ...
            <div className="flex justify-between p-6 items-center w-[724px]">
              ...
              <div className="flex gap-2">
                <button className="text-white bg-[#18BA51] w-[94px] h-[36px] rounded-lg">
                  Өнөөдөр
                </button>
                <button className="w-[82px] h-[36px] rounded-lg border-[1px]">
                  7 хоног
                </button>
                <button className="w-[132px] h-[36px] rounded-lg border-[1px]">
                  Сараар
                </button>
              </div>
            </div>
